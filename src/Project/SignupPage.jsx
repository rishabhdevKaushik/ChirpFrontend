  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/bg1.jpeg')" }}>
      ...
      <div className="relative z-10 backdrop-blur-md w-full max-w-sm bg-gray-900 bg-opacity-70 rounded-lg shadow-xl p-6 sm:p-8 transform transition duration-500 hover:scale-105 hover:shadow-2xl">
        ...
        {error && <p className="text-red-500 text-center mb-2 animate__animated animate__fadeIn">{error}</p>}
        ...
        <form className="space-y-3" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full ${loading ? "bg-gray-600" : "bg-gradient-to-r from-blue-500 to-purple-600"} text-white py-2 rounded-md shadow-md hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-sm`}
          >
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-gray-400">
            ...
            <button onClick={handleLogin} className="text-blue-400 hover:underline font-medium">
              Login
            </button>
          </p>
        </div>
