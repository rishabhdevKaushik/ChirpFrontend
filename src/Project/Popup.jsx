...
const Popup = ({ setIsPopupOpen }) => {
  ...
  return (
    <div>
      <Dialog onClose={handleClose} className="fixed inset-0 z-50 flex items-center justify-center">
        <motion.div
        ...
        >
          ...
          <div className="flex justify-end gap-4">
            <Button onClick={handleCancel} className="bg-gray-300 text-gray-700 hover:bg-gray-400">
              Cancel
            </Button>
