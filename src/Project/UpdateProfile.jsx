...
const UpdateProfile = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
      <h1 className="text-3xl font-semibold text-center text-gray-700 mb-8">Update Profile</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* New Username */}
        <div className="relative">
          <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="newUsername">
        ...
        {/* New Email */}
        <div className="relative">
          <label className="block text-gray-700 text-sm font-medium mb-2" htmlFor="newEmail">
            New Email (Optional)
          </label>
          <input
            type="email"
